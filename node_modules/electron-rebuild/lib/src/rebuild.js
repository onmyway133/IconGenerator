...
class Rebuilder {
    ...
    rebuildModuleAt(modulePath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nodeFile = (yield fs.readdir(path.resolve(modulePath, 'build/Release')))
...
;
function createOptions(buildPath, electronVersion, arch, extraModules, force, headerURL, types, mode, onlyModules) {
    return {
        buildPath,
        electronVersion,
        arch,
